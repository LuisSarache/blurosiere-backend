...
from app.database import get_db  # Função que retorna uma sessão do banco de dados
from app.models.models import User, Appointment, Patient, UserType  # Importa os modelos do banco de dados
from app.schemas.schemas import PatientCreate, Patient as PatientSchema  # Importa schemas para validação e resposta
from app.services.auth_service import get_current_user  # Função que retorna o usuário autenticado
from app.utils import calculate_age  # Função auxiliar para calcular idade a partir da data de nascimento
