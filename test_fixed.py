...
class TestRunner:
    ...
    def login(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"{Colors.OKGREEN}✅ Login realizado como: {self.user['name']} (Tipo: {self.user['type']}){Colors.RESET}")
                return True
            else:
    ...
    def test_requests(self):
        ...
        # GET - endpoint correto com barra final
        ...
        # POST - endpoint correto com barra final
        ...
        request_data = {
            ...
            "urgency": "media"  # Valor correto conforme enum
        }
